import { d as defineComponent, r as ref, as as useNDVStore, U as useWorkflowsStore, cn as storeToRefs, q as computed, o as onMounted, I as watch, m as resolveComponent, c as openBlock, h as createElementBlock, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, F as Fragment, B as renderList, i as createVNode, w as withCtx, ax as withDirectives, e as createBlock, l as unref, aR as _sfc_main$1, ay as vShow, aQ as N8nTooltip, k as createTextVNode, t as toDisplayString, c$ as InfoTip, h9 as Draggable, hY as MappingPill, x as shorten, hZ as TextWithHighlights, h_ as Tree, g as useI18n, h$ as getPairedItemId, i0 as getMappedExpression, aU as useExternalHooks, ak as useTelemetry, _ as _export_sfc } from "./index-DkwrpQEB.js";
...
const _hoisted_6 = ["data-name", "data-value", "data-depth", "onMouseenter"];
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList(tableData.value.data, (row, index1) => {
                return openBlock(), createElementBlock("tr", {
                    ...
                    return openBlock(), createElementBlock("td", {
                      ...
                      isSimple(data) ? (openBlock(), createBlock(TextWithHighlights, {
                        ...
                        label: withCtx(({ label, path }) => [
                          ...
                          }, toDisplayString(label || unref(i18n).baseText("runData.unnamedField")), 43, _hoisted_6)
                        ]),
                  ...
                  columnLimitExceeded.value ? (openBlock(), createElementBlock("td", _hoisted_7)) : createCommentVNode("", true),
                  createBaseVNode("td", {
                    class: normalizeClass(_ctx.$style.tableRightMargin)
                  }, null, 2)
                ], 10, _hoisted_3);
