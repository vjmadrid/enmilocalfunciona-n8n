...
const label$1 = "_label_1sqfw_123";
const style0$b = {
  label: label$1
};
const cssModules$b = {
...
const noResults = "_noResults_646or_123";
const title$1 = "_title_646or_136";
const action = "_action_646or_145";
const request = "_request_646or_146";
const icon = "_icon_646or_162";
const external = "_external_646or_168";
const style0$3 = {
  noResults,
  title: title$1,
  action,
  ...
  setup(__props, { emit: __emit }) {
    ...
    function onSelected(item) {
      ...
      if (item.type === "node") {
        ...
        const icon2 = iconUrl ? rootStore.baseUrl + iconUrl : getNodeIcon(item.properties, uiStore.appliedTheme)?.split(":")[1];
