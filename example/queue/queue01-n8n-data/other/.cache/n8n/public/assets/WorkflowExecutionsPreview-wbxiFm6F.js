import { d as defineComponent, m as resolveComponent, c as openBlock, h as createElementBlock, i as createVNode, n as normalizeClass, _ as _export_sfc, at as useExecutionsStore, a as useToast, r as ref, q as computed, bW as resolveDirective, j as createBaseVNode, t as toDisplayString, l as unref, e as createBlock, F as Fragment, B as renderList, w as withCtx, k as createTextVNode, ax as withDirectives, g as useI18n, D as createEventBus, ak as useTelemetry, W as useRoute, b as useRouter, U as useWorkflowsStore, p as useSettingsStore, bX as useTestDefinitionStore, o as onMounted, f as createCommentVNode, V as VIEWS, b0 as mergeProps, bY as ElDropdown, af as MODAL_CONFIRM, al as useMessage, am as getResourcePermissions, a9 as EnterpriseEditionFeature } from "./index-DkwrpQEB.js";
import { u as useExecutionDebugging } from "./useExecutionDebugging-eHQMFoAz.js";
import { _ as _sfc_main$3 } from "./AnnotationTagsDropdown.ee.vue_vue_type_script_setup_true_lang-CVAPh1f-.js";
import { W as WorkflowPreview } from "./WorkflowPreview-DDD47V5y.js";
import { u as useExecutionHelpers } from "./useExecutionHelpers-DTlfzIbO.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const addToTestActions = computed(() => {
      const testAction = testDefinitions.value.filter((test) => test.annotationTagId).map((test) => {
    ...
    function getTestButtonLabel(isAdded) {
      if (isAdded) {
        return locale.baseText("testDefinition.executions.addedTo", {
          interpolate: { name: testDefinition.value?.name ?? "" }
        });
      }
      return testDefinition.value ? locale.baseText("testDefinition.executions.addTo.existing", {
        interpolate: { name: testDefinition.value.name }
      }) : locale.baseText("testDefinition.executions.addTo.new");
    }
    const addTestButtonData = computed(() => {
      const isAdded = isTagAlreadyAdded(route.query.tag);
      return {
    ...
    async function handleAddToTestAction(actionValue) {
      if (actionValue === "new") {
        await router.push({
    ...
    async function handleEvaluationButton() {
      if (!testDefinition.value) {
        ...
        await handleAddToTestAction(route.query.tag);
      }
    }
    onMounted(async () => {
      ...
      return executionUIDetails.value?.name === "new" ? (openBlock(), createElementBlock("div", {
        ...
        _ctx.execution ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", null, [
            ...
            _ctx.execution.mode === "retry" ? (openBlock(), createBlock(_component_N8nText, {
              key: 4,
              color: "text-base",
              size: "medium"
            }, {
          ...
          createBaseVNode("div", {
            ...
            testDefinitions.value && testDefinitions.value.length ? (openBlock(), createBlock(ProjectCreateResource, {
              key: 0,
              ref_key: "actionToggleRef",
              ref: actionToggleRef,
              actions: addToTestActions.value,
              type: addTestButtonData.value.type,
              onAction: handleAddToTestAction
            }, {
              default: withCtx(() => [
                createVNode(_component_N8nButton, mergeProps({ "data-test-id": "add-to-test-button" }, addTestButtonData.value, { onClick: handleEvaluationButton }), null, 16)
              ]),
              _: 1
            }, 8, ["actions", "type"])) : createCommentVNode("", true),
            createVNode(_component_router_link, {
              to: {
            ...
            isRetriable.value ? (openBlock(), createBlock(unref(ElDropdown), {
              ...
              dropdown: withCtx(() => [
                createVNode(_component_ElDropdownMenu, null, {
                  default: withCtx(() => [
                    createVNode(_component_ElDropdownItem, { command: "current-workflow" }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(locale).baseText("executionsList.retryWithCurrentlySavedWorkflow")), 1)
                      ]),
                      _: 1
                    }),
                    createVNode(_component_ElDropdownItem, { command: "original-workflow" }, {
                      default: withCtx(() => [
