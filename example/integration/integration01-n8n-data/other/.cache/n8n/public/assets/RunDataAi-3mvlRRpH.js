import { c1 as getDefaultExportFromCjs, d as defineComponent, b7 as useClipboard, a as useToast, dL as useAIAssistantHelpers, bp as useNodeTypesStore, as as useNDVStore, $ as useRootStore, da as useAssistantStore, L as useUIStore, q as computed, dM as MAX_DISPLAY_DATA_SIZE, dN as isCommunityPackageName, m as resolveComponent, bW as resolveDirective, c as openBlock, h as createElementBlock, j as createBaseVNode, t as toDisplayString, ax as withDirectives, f as createCommentVNode, i as createVNode, l as unref, dO as InlineAskAssistantButton, w as withCtx, k as createTextVNode, F as Fragment, B as renderList, g as useI18n, dP as NEW_ASSISTANT_SESSION_MODAL, bZ as sanitizeHtml, bi as NodeConnectionType, dQ as isObjectEmpty, r as ref, o as onMounted, n as normalizeClass, e as createBlock, b2 as VueMarkdown, _ as _export_sfc, U as useWorkflowsStore, cD as _sfc_main$4, J as withModifiers, I as watch, C as normalizeStyle, dR as ElTree } from "./index-DkwrpQEB.js";
import { c as capitalize } from "./usePinnedData-cAEPUGIg.js";
...
function createNode(nodeName, currentDepth, r, children = []) {
  return {
    node: nodeName,
    id: nodeName,
    depth: currentDepth,
...
function getTreeNodeData(nodeName, workflow, aiData) {
  return getTreeNodeDataRec(nodeName, 0, workflow, aiData, void 0);
}
function getTreeNodeDataRec(nodeName, currentDepth, workflow, aiData, runIndex) {
  ...
  const children = connectedSubNodes.flatMap((name) => {
    return aiData?.filter(
      (data) => data.node === name && (runIndex === void 0 || data.runIndex === runIndex)
    ).flatMap(
      (data) => getTreeNodeDataRec(name, currentDepth + 1, workflow, aiData, data.runIndex)
    ) ?? [];
  });
