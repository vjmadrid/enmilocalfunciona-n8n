import { d as defineComponent, s as MAIN_HEADER_TABS, c as openBlock, h as createElementBlock, i as createVNode, n as normalizeClass, f as createCommentVNode, m as resolveComponent, _ as _export_sfc, q as computed, v as renderSlot, x as shorten, r as ref, y as onBeforeUnmount, o as onMounted, z as nextTick, A as debounce, e as createBlock, w as withCtx, j as createBaseVNode, B as renderList, F as Fragment, C as normalizeStyle, l as unref, D as createEventBus, k as createTextVNode, t as toDisplayString, E as useTagsStore, G as onClickOutside, H as withKeys, I as watch, J as withModifiers, K as useDebounce, L as useUIStore, N as getBannerRowHeight, O as BREAKPOINT_SM, P as BREAKPOINT_XL, Q as BREAKPOINT_LG, R as BREAKPOINT_MD, g as useI18n, V as VIEWS, S as defineStore, T as STORES, U as useWorkflowsStore, u as useUsersStore, W as useRoute, X as TIME, Y as PLACEHOLDER_EMPTY_WORKFLOW_ID, Z as useDocumentVisibility, $ as useRootStore, a0 as useCanvasStore, p as useSettingsStore, a1 as useSourceControlStore, a2 as useProjectsStore, a3 as useNpsSurveyStore, b as useRouter, a as useToast, a4 as useDocumentTitle, a5 as useWorkflowHelpers, a6 as usePageRedirectionHelper, a7 as MAX_WORKFLOW_NAME_LENGTH, a8 as _sfc_main$f, a9 as EnterpriseEditionFeature, aa as SaveButton, ab as useCssModule, ac as WORKFLOW_SHARE_MODAL_KEY, ad as nodeViewEventBus, ae as WORKFLOW_MENU_ACTIONS, af as MODAL_CONFIRM, ag as WORKFLOW_SETTINGS_MODAL_KEY, ah as SOURCE_CONTROL_PUSH_MODAL_KEY, ai as VALID_WORKFLOW_IMPORT_URL_REGEX, aj as DUPLICATE_MODAL_KEY, ak as useTelemetry, al as useMessage, am as getResourcePermissions, an as hasPermission, ao as hyphenate, ap as h, aq as hasOwn, ar as __vitePreload, as as useNDVStore, at as useExecutionsStore, au as usePostHog, av as useLocalStorage, aw as onBeforeMount, ax as withDirectives, ay as vShow, az as N8N_MAIN_GITHUB_REPO_URL, aA as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, aB as WORKFLOW_EVALUATION_EXPERIMENT, aC as STICKY_NODE_TYPE } from "./index-DkwrpQEB.js";
import { _ as _sfc_main$g } from "./PushConnectionTracker.vue_vue_type_script_setup_true_lang-DCOYMajh.js";
...
import { u as usePushConnection } from "./usePushConnection-De7r5t9d.js";
import "./useWorkflowActivate-COcGS4jx.js";
import "./global-link-actions-D2_SnpTc.js";
import "./easyAiWorkflowUtils-qtdB9CeQ.js";
...
const WorkflowDetails = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__cssModules", cssModules$1], ["__scopeId", "data-v-a432f2c0"]]);
...
const container = "_container_rfz01_123";
const style0 = {
  container,
  "main-header": "_main-header_rfz01_130",
  "top-menu": "_top-menu_rfz01_138",
  "github-button": "_github-button_rfz01_147",
  "close-github-button": "_close-github-button_rfz01_156",
  "github-button-container": "_github-button-container_rfz01_171"
};
const cssModules = {
  "$style": style0
};
