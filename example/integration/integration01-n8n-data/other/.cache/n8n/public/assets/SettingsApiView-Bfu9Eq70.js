import { d as defineComponent, r as ref, m as resolveComponent, c as openBlock, e as createBlock, w as withCtx, j as createBaseVNode, i as createVNode, n as normalizeClass, k as createTextVNode, t as toDisplayString, h as createElementBlock, f as createCommentVNode, aK as DateTime, g as useI18n, _ as _export_sfc, p as useSettingsStore, L as useUIStore, aI as useCloudPlanStore, a as useToast, a4 as useDocumentTitle, a6 as usePageRedirectionHelper, cm as useApiKeysStore, cn as storeToRefs, $ as useRootStore, o as onMounted, co as DOCS_DOMAIN, l as unref, F as Fragment, B as renderList, cp as API_KEY_CREATE_OR_EDIT_MODAL_KEY, ak as useTelemetry, af as MODAL_CONFIRM, al as useMessage } from "./index-DkwrpQEB.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        unref(apiKeysSortByCreationDate).length ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(apiKeysSortByCreationDate), (apiKey) => {
          ...
          createBaseVNode("div", _hoisted_4, [
            createVNode(_component_n8n_button, {
              size: "large",
              disabled: !unref(apiKeysStore).canAddMoreApiKeys,
        ...
        ], 64)) : !unref(isPublicApiEnabled) && unref(cloudPlanStore).userIsTrialing ? (openBlock(), createBlock(_component_n8n_action_box, {
          key: 2,
...
const header = "_header_1b7g8_123";
const card = "_card_1b7g8_133";
const destinationItem = "_destinationItem_1b7g8_137";
const topHint = "_topHint_1b7g8_148";
const BottomHint = "_BottomHint_1b7g8_159";
const style0 = {
  header,
  card,
  destinationItem,
  "delete": "_delete_1b7g8_141",
  topHint,
  BottomHint
};
const cssModules = {
