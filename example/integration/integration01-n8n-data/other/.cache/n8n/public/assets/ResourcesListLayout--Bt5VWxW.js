import { _ as _export_sfc, c as openBlock, h as createElementBlock, v as renderSlot, j as createBaseVNode, n as normalizeClass, d as defineComponent, f as createCommentVNode, a2 as useProjectsStore, q as computed, I as watch, aw as onBeforeMount, e as createBlock, w as withCtx, i as createVNode, k as createTextVNode, t as toDisplayString, l as unref, a9 as EnterpriseEditionFeature, fL as ProjectSharing, g as useI18n, m as resolveComponent, W as useRoute, b as useRouter, K as useDebounce, u as useUsersStore, r as ref, fa as useSlots, o as onMounted, z as nextTick, F as Fragment, B as renderList, a_ as normalizeProps, a$ as guardReactiveProps, ax as withDirectives, ay as vShow, fM as isSharedResource, fN as isResourceSortableByDate, ak as useTelemetry } from "./index-DkwrpQEB.js";
...
const style0$1 = {
  "filter-button": "_filter-button_12o3u_123",
  "no-label": "_no-label_12o3u_127",
  "filter-button-count": "_filter-button-count_12o3u_130",
  "filter-button-text": "_filter-button-text_12o3u_139",
  "filters-dropdown": "_filters-dropdown_12o3u_147",
  "filters-dropdown-footer": "_filters-dropdown-footer_12o3u_151"
};
const cssModules$1 = {
  "$style": style0$1
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const showEmptyState = computed(() => {
      return route.params.folderId === void 0 && props.resources.length === 0 && // Don't show empty state if resources are refreshing or if filters are being set
...
const filters = "_filters_xnuum_123";
const search = "_search_xnuum_155";
const listWrapper = "_listWrapper_xnuum_160";
const paginatedListWrapper = "_paginatedListWrapper_xnuum_166";
const listPagination = "_listPagination_xnuum_174";
const datatable = "_datatable_xnuum_201";
const style0 = {
  "filters-row": "_filters-row_xnuum_123",
  filters,
  "sort-and-filter": "_sort-and-filter_xnuum_141",
  search,
  listWrapper,
...
const ResourcesListLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__cssModules", cssModules], ["__scopeId", "data-v-27759bc2"]]);
export {
